...
const FloatingDoc = () => {
  ...
  return (
    <motion.div
      ...
      className="w-max  max-w-[650px] h-16 z-50 fixed bottom-5 border border-[#F5F6FF] rounded-2xl customShadow bg-white left-1/2 -translate-x-1/2 flex justify-between items-center px-5"
    >
